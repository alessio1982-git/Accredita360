...
const admin = {
    ...
    renderNotifications() {
        ...
        container.innerHTML = this._userNotifications.map(n => `
            <div class="notification-item ${n.read ? '' : 'unread'}" onclick="admin.markNotifRead('${n.id}');">
    ...
    openReqChatModal(requirementId, customStructEmail) {
        ...
        header.innerHTML = `
            ...
            <h4 style="font-size: 15px; font-weight: 700; color: var(--text-main); margin-top: 2px;">Discussion &amp; Commenti (Supervisione Admin)</h4>
        `;
...
document.addEventListener('DOMContentLoaded', () => {
    admin.init();
    setTimeout(() => { admin.initNotifications(); }, 800);
});
